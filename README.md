...
A mockup UI for a Unified Management System (UMS), designed for managing SPEA applications, user roles, and access.

This is a static front-end prototype (HTML/CSS + Bootstrap) — no backend, just placeholder data to demonstrate the look and flow of the system.
